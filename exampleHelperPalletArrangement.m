...
boxDimxy(1) = 1.1*boxDim(1); % Expand the size of the box by a small amount to prevent collisions
boxDimxy(2) = 1.1*boxDim(2);
nRows = floor(palletDim(1)/boxDimxy(1));
nCols = floor(palletDim(2)/boxDimxy(2));
